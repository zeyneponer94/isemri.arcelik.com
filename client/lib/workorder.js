    ...
    angular.module('App').controller('Controller', function ($scope, $http, $window,dialogs) {
       ...
       $scope.query_workorder = function () {
        ...
        {       
          ...
          var dlg = dialogs.confirm("Lütfen Onaylayınız!","Aşağıda belirtilen bilgiler ile iş emri oluşturma talebinizi gerçekleştirmeyi onaylıyor musunuz?".bold()+"<br><br><br>"+ ("Müşteri adı = "+$scope.name_id+"<br><br>Müşteri soyadı = "
          +$scope.surname_id+"<br><br><br>Müşteri telefon numarası = "+$scope.phone_id+"<br><br><br>Seçilen ürün = "+$scope.singleSelect+"<br><br><br>Seçilen iş emri türü = "
          +$scope.workorderSelect+"<br><br><br>Müşteri adresi = " + $scope.provinceSelect + " " +$scope.citySelect).italics());
